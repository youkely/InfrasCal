...
void
EquidistantCamera::centerize(Eigen::Vector2d& p_pixel) const
{
    p_pixel(0) = p_pixel(0) - mParameters.u0();
    p_pixel(1) = p_pixel(1) - mParameters.v0();
}
...
void
EquidistantCamera::setPrinciplePoint(const std::vector<double>& cxcy)
{
    Parameters params = getParameters();
    params.u0() = cxcy.at(0);
    params.v0() = cxcy.at(1);
...
void
EquidistantCamera::getPrinciplePoint(std::vector<double>& cxcy) const
{
    Parameters params = getParameters();
    cxcy.at(0) = params.u0();
    cxcy.at(1) = params.v0();
...
void
EquidistantCamera::setFocalLength(const std::vector<double> &fxfy)
{
    Parameters params = getParameters();
    params.mu() = fxfy.at(0);
    params.mv() = fxfy.at(1);
