...
void
CataCamera::centerize(Eigen::Vector2d& p_pixel) const
{
...
void
CataCamera::setPrinciplePoint(const std::vector<double>& cxcy)
{
    Parameters params = getParameters();
    params.u0() = cxcy.at(0);
    params.v0() = cxcy.at(1);
...
void
CataCamera::getPrinciplePoint(std::vector<double>& cxcy) const
{
    Parameters params = getParameters();
    cxcy.at(0) = params.u0();
    cxcy.at(1) = params.v0();
