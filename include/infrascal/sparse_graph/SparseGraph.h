...
#include <infrascal/sparse_graph/Odometry.h>
#include <infrascal/sparse_graph/Pose.h>
...
public:
    ...
    bool readFromColmap(const std::string& mapName, const std::string& databaseName);
