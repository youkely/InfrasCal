...
public:
    ...
    */
    ...
    void centerize(Eigen::Vector2d& p_pixel) const;
    ...
    void setPrinciplePoint(const std::vector<double>& cxcy);
    void getPrinciplePoint(std::vector<double>& cxcy) const;
    void setFocalLength(const std::vector<double>& fxfy);
