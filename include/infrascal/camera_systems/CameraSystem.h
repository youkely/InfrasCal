...
public:
    ...
    bool readExtrinsicsFromTextFile(const std::string& directory);
    ...
    const int getReferenceCameraId();
...
private:
    ...
    std::vector<Eigen::Matrix4d, Eigen::aligned_allocator<Eigen::Matrix4d> > m_localPoses;
