...
The workings of the library are described in the three papers:
        ...
        Infrastructure-based Multi-Camera Calibration using Radial Projections, to bu published.
...
4. Infrastructure-based calibration
  ...
  [2]: https://github.com/hengli/infrascal/blob/master/src/examples/intrinsic_calib.cc "src/examples/intrinsic_calib.cc"
  [3]: https://github.com/hengli/infrascal/blob/master/src/examples/stereo_calib.cc "src/examples/stereo_calib.cc"
  [4]: https://github.com/hengli/infrascal/blob/master/src/examples/extrinsic_calib.cc "src/examples/extrinsic_calib.cc"
