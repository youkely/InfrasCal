...
set(_info_text "Puts all installed files in subfolders of the install prefix path. That root folder can then be moved, copied and renamed as you wish. The executable will not write to folders like ~/.infrascal or \"Application Data\"")
if(UNIX)
...
if(INSTALL_COPYABLE)
  ...
  set(INFRASCAL_RUNTIME_INSTALL_PATH ${DEFAULT_RUNTIME_PATH})
  set(INFRASCAL_LIBRARY_INSTALL_PATH ${DEFAULT_LIBRARY_PATH})
  set(INFRASCAL_ARCHIVE_INSTALL_PATH ${DEFAULT_ARCHIVE_PATH})
  SET(INFRASCAL_DOC_INSTALL_PATH     ${DEFAULT_DOC_PATH})

elseif(UNIX) # Apple too?
  # Using absolute paths
  set(INFRASCAL_RUNTIME_INSTALL_PATH ${CMAKE_INSTALL_PREFIX}/bin)
  set(INFRASCAL_LIBRARY_INSTALL_PATH ${CMAKE_INSTALL_PREFIX}/lib/infrascal)
  set(INFRASCAL_ARCHIVE_INSTALL_PATH ${CMAKE_INSTALL_PREFIX}/lib/infrascal/static)
  set(INFRASCAL_DOC_INSTALL_PATH     ${CMAKE_INSTALL_PREFIX}/share/doc/infrascal)

elseif(WIN32)
  set(INFRASCAL_RUNTIME_INSTALL_PATH ${CMAKE_INSTALL_PREFIX}/${DEFAULT_RUNTIME_PATH})
  set(INFRASCAL_LIBRARY_INSTALL_PATH ${CMAKE_INSTALL_PREFIX}/${DEFAULT_LIBRARY_PATH})
  set(INFRASCAL_ARCHIVE_INSTALL_PATH ${CMAKE_INSTALL_PREFIX}/${DEFAULT_ARCHIVE_PATH})
  set(INFRASCAL_DOC_INSTALL_PATH     ${CMAKE_INSTALL_PREFIX}/${DEFAULT_DOC_PATH})
endif()
...
set(CMAKE_INSTALL_RPATH ${INFRASCAL_LIBRARY_INSTALL_PATH})
